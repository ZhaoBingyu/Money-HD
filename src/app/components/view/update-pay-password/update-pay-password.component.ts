...
@Component({
  selector: 'app-update-pay-password',
  templateUrl: './update-pay-password.component.html',
  styleUrls: ['./update-pay-password.component.css']
})


export class UpdatePayPasswordComponent implements OnInit {
  ...
  submit() {
    ...
    const reqData = this.common.api_fundChangePayPassword(sendData);

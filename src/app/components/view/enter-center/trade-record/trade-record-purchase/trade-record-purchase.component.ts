...
@Component({
  selector: 'app-trade-record-purchase',
  templateUrl: './trade-record-purchase.component.html',
  styleUrls: ['./trade-record-purchase.component.css']
})

export class TradeRecordPurchaseComponent implements OnInit {
  queryLoading = false;
  date: any;
...
//  查询
  querySubmit() {
    ...
    const resData = this.common.api_fundBuyProductList(sendData);

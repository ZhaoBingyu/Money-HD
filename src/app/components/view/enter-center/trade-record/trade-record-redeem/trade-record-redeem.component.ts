...
@Component({
  selector: 'app-trade-record-redeem',
  templateUrl: './trade-record-redeem.component.html',
  styleUrls: ['./trade-record-redeem.component.css']
})


export class TradeRecordRedeemComponent implements OnInit {
  queryLoading = false;
  date: any;
...
//  查询
  querySubmit() {
    ...
    const resData = this.common.api_fundVolProductList(sendData);

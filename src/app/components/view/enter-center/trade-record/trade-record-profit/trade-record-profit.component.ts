...
@Component({
  selector: 'app-trade-record-profit',
  templateUrl: './trade-record-profit.component.html',
  styleUrls: ['./trade-record-profit.component.css']
})

export class TradeRecordProfitComponent implements OnInit {
  queryLoading = false;
  date: any;
